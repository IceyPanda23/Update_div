...
# JOSHUA EDIT HEREEEEE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# JOSHUA EDIT HEREEEEE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# Comment out the 2 rows below this line result and print comment those 2 out
        ...
        output_file_path = fr'./DIVS_NOT_UPDATED_{db_name}_{payment_name}.xlsx'
        df_output.to_excel(excel_writer=output_file_path,engine='openpyxl')
