    ...
    def run_updates(engine, db_name, table_name, div_list):
        ...
        with engine.begin() as connection:
            ...
            for div_no in div_list:
                ...
                try:
                    # try:
                    #     div_no_float = float(div_no)
                    #     div_no_int = int(div_no_float)

                    #     # Check if it was a whole number
                    #     if div_no_float != div_no_int:
                    #         raise ValueError("Not a whole number")

                    #     div_no = div_no_int
                    # except (ValueError, TypeError):
                    #     print(f"⚠️ Skipping invalid DividendNo '{div_no}' (non-integer or malformed)")
